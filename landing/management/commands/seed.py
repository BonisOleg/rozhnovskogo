...
class Command(BaseCommand):
    ...
    def _seed_about(self):
        ...
        obj.philosophy_text = (
            'ПП «Укркотлобуд» — виробник водонапірних башт Рожновського об\'ємом від 10 до 200 м³. '
    ...
    def _seed_services(self):
        ...
        prods = [
            ('Водонапірні башти Рожновського', 'Виготовлення башт від 10 до 200 м³ зі сталі. Типові та індивідуальні проекти. Гарантія від виробника.'),
